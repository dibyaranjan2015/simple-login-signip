<?php
include('includes/upload_error.php');
		...
		if(!empty($error)){
			echo $error;
			 ...
			 $username = trim($_POST['username']);
			  ...
			  $query = "INSERT INTO `user` (`id`, `firstname`, `lastname`, `username`, `hash_password`, `email`,`phone`,`gender`,`image`) VALUES (NULL, '".$firstname."', '".$lastname."','".$username."', '".$hash_password."', '".$email."', '".$phone."', '".$gender."','".$image."')";
			 ...
			 if($user_detail){
				 ...
				 if (mail($to,$subject,$message,$header)){
				  ...
				  redirect_to("index.php?signup=1");
